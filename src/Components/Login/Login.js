                        ...
                        <div className="p-4  p-sm-5">
                            ...
                            <form className="loginForm" onSubmit={handleSubmit}>
                                ...
                                <div class="form-group">
                                    {newUser && <input onBlur={onBlur} type="text" name="name" class="form-control" placeholder="First Name" required />}
                                    {newUser && <input onBlur={onBlur} type="text" name="name" class="form-control" placeholder="Last Name" required />}


                                    <input onBlur={onBlur} type="email" name="email" class="form-control" placeholder="name@example.com" required />
                                    <input onBlur={onBlur} name="password" type="password" class="form-control" placeholder="Password" required />

                                    {newUser && <input onBlur={onBlur} name="retypePassword" type="password" class="form-control" placeholder="Confirm Password" required />}
                            ...
                            <label html for="newUser" className="pr-2">{newUser ? ' Already have Account' : ' please Login'} </label>
